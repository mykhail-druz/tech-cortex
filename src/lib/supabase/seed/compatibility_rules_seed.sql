...
(category_id, name, display_name, description, is_required, data_type, is_compatibility_key, enum_values)
VALUES 
((SELECT id FROM categories WHERE name = 'Memory'), 
...
(category_id, name, display_name, description, is_required, data_type, is_compatibility_key, enum_values)
VALUES 
((SELECT id FROM categories WHERE name = 'Graphics Cards'), 
...
(category_id, name, display_name, description, is_required, data_type, is_compatibility_key, enum_values)
VALUES 
((SELECT id FROM categories WHERE name = 'Power Supplies'), 
...
(SELECT id FROM categories WHERE name = 'Motherboards'),
(SELECT id FROM category_specification_templates WHERE name = 'memory_type' AND category_id = (SELECT id FROM categories WHERE name = 'Motherboards')),
(SELECT id FROM categories WHERE name = 'Memory'),
(SELECT id FROM category_specification_templates WHERE name = 'memory_type' AND category_id = (SELECT id FROM categories WHERE name = 'Memory')),
'exact_match');
...
(SELECT id FROM categories WHERE name = 'Graphics Cards'),
(SELECT id FROM category_specification_templates WHERE name = 'power_requirement' AND category_id = (SELECT id FROM categories WHERE name = 'Graphics Cards')),
(SELECT id FROM categories WHERE name = 'Power Supplies'),
(SELECT id FROM category_specification_templates WHERE name = 'wattage' AND category_id = (SELECT id FROM categories WHERE name = 'Power Supplies')),
'range_check', 0);
...
VALUES
('00000000-0000-0000-0000-000000000004', -- Replace with actual product ID
(SELECT id FROM category_specification_templates WHERE name = 'power_connector' AND category_id = (SELECT id FROM categories WHERE name = 'Graphics Cards')),
...
VALUES
('00000000-0000-0000-0000-000000000005', -- Replace with actual product ID
(SELECT id FROM category_specification_templates WHERE name = 'available_connectors' AND category_id = (SELECT id FROM categories WHERE name = 'Power Supplies')),
