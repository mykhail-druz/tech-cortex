      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <div className="mt-4 p-4 bg-yellow-50 border border-yellow-300 rounded-lg text-yellow-800">
            ...
            <p>This PC Builder provides recommendations only. We do not take responsibility for component compatibility or assembly issues. Always verify compatibility with manufacturers' specifications before purchasing or assembling components.</p>
          </div>
