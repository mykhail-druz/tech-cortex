  ...
  return (
    <div className="hidden lg:block w-full lg:w-80 flex-shrink-0">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="h-[500px] overflow-y-auto overflow-x-hidden custom-scrollbar pr-2 mb-4">
          {/* Search */}
                  ...
                  {(() => {
                    ...
                    const handleTrackClick = (event: React.MouseEvent) => {
                      ...
                      if (distToMin <= distToMax) {
                        // Move min handle
                        handlePriceChange(Math.min(value, localPriceRange[1]), localPriceRange[1]);
                      } else {
                        // Move max handle
                        handlePriceChange(localPriceRange[0], Math.max(value, localPriceRange[0]));
                      }
                    };
                    ...
                    return (
                      <>
                        ...
                        <div
                          ...
                          style={{ left: `${minPercent}%`, marginLeft: '0px' }}
                        ...
                        <div
                          ...
                          style={{ left: `${maxPercent}%`, marginLeft: '-20px' }}
